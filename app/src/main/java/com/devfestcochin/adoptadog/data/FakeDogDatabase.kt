package com.devfestcochin.adoptadog.data

import com.devfestcochin.adoptadog.R
import com.devfestcochin.adoptadog.model.Dog
import com.devfestcochin.adoptadog.model.Owner

object FakeDogDatabase {
    private val owner = Owner("Nitheesh", "Developer & Pet Lover", R.drawable.owner)
    val dogList = listOf(
        Dog(
            0,
            "Hachiko",
